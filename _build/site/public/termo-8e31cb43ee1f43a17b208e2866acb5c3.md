...
Podemos produzir fontes de radiação praticamente com apenas um comprimento de onda, como os lasers. Cada elemento químico emite radiação com comprimentos de onda específicos, que são uma assinatura do 
