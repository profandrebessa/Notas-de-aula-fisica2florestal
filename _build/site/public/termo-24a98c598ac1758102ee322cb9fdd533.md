...
(b) Calcule a variação de temperatura para o solo úmido ($c_u = 1800\, J/(kg^\circ C)$, em que ocorre evaporação de água a uma taxa de $ 1,0 \times 10^{-4}\text{kg/s}$. Use que o calor latente de vaporização da água a temperatura ambiente é $L_v = 2{,}5 \times 10^6\ \text{J/kg}$.\
