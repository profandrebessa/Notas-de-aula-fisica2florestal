...
K = \frac{1}{2}mv^2\;.
\end{equation}
A unidade padrão da energia cinética é o Joule. Exemplo: uma pedra de 1 kg atinge o chão com velocidade de 3 m/s. Qual era a sua energia cinética? $K = 0,5*(1\,kg)*(3\,m/s)^2= 4,5\,J$.
