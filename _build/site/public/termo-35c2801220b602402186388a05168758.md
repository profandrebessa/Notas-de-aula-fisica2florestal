...
1) Você projetou uma casa solar que contém $1,0 \times 10^5$ kg de concreto (calor específico aproximado igual a $1,0$ kJ/(kg K)). Quanto calor é liberado pelo concreto à noite, quando ele resfria de $25^\circ$ C para $20^\circ$ C? \small {\bf Resp.: 5 $\times 10^5$ kJ} \normalsize} 
