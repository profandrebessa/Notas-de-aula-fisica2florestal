...
Um sistema com muita massa vai demandar muita energia para se aquecer. Portanto, massa maior implica em maior capacidade térmica. Assim, a pergunta: "Quem tem maior capacidade térmica, a água ou a areia?" deve ser pensada para iguais massa de água e areia. 

Perguntamos, então: quantos joules de energia devemos fornecer a um kg de uma substância para elevar a sua temperatura em 1$^\circ$C? 

Essa quantidade é uma capacidade térmica por massa e se chama **calor específico**. Ela será representada pela leta $c$, em minúsculo. O calor específico é medido em joules por kg, por grau Celsius $J/(kg^\circ C)$ ou, equivalentemente, em joules por kg, por Kelvin $J/(kg K)$. 
