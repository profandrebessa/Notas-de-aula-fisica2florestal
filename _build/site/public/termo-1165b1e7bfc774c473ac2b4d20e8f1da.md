...
Considere um sistema com capacidade térmica $C=12J/^\circ C$. Para variar a sua temperatura em $5^\circ C$ devemos fornecer ao sistema $5\times 12 = 60J$. Em geral, para uma variação de temperatura $\Delta T$ devemos fornecer a seguinte quantidade de energia:
\begin{equation}
Q \;=\;C\;\Delta T.
\end{equation} 

Um sistema com muita massa vai demandar muita energia para se aquecer. Portanto, massa maior implica em maior capacidade térmica. Assim, a pergunta: "Quem tem maior capacidade térmica, a água ou a areia?" deve ser pensada para igual massa de água e areia. 
...
1) Você projetou uma casa solar que contém $1,0 \times 10^5$ kg de concreto (calor específico aproximado igual a $1,0$ kJ/(kg K)). Quanto calor é liberado pelo concreto à noite, quando ele resfria de $25^\circ$ C para $20^\circ$ C? Resp.: 5 $\times 10^5$ kJ.
