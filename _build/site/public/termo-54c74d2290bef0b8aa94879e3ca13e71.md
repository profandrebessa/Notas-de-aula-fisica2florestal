...
(a) Considerando que toda a energia fornecida vai para o aumento de temperatura, calcule a variação de temperatura considerando o solo seco, com $c_s = 800\ \hbox{J/(kg·K)}$\
