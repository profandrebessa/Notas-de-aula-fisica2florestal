...
1) Você projetou uma casa solar que contém $1,0 \times 10^5$ kg de concreto (calor específico aproximado igual a $1,0$ kJ/(kg K)). Quanto calor é liberado pelo concreto à noite, quando ele resfria de $25^\circ$ C para $20^\circ$ C? \scriptsize {\bf Resp.: 5 $\times 10^5$ kJ} \normalsize} 

2) Você precisa comprar um aquecedor de água para a sua piscina de 20.000 L. Desprezando as perdas de calor da água da piscina para o ambiente, qual deve ser potência desse aquecedor se você quer que a água passe de $23,9^\circ$ C para $36,0^\circ$ C em $2$ h? \scriptsize {\bf Resp.: 140,5 kJ} \normalsize}
